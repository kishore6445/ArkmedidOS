        ...
        <div className='relative overflow-hidden'>
          ...
          <div className='relative overflow-hidden'>
            ...
            <div className='hidden lg:flex lg:items-stretch lg:gap-0 p-6 bg-stone-50'>
              {/* Column 1: WEEKLY POWER MOVES - AMBER/ORANGE Theme */}
              <div className='flex-1 flex flex-col items-center justify-center text-center bg-gradient-to-br from-amber-50 to-orange-50 border-l-4 border-t-4 border-b-4 border-amber-400 border-r-2 border-r-stone-200 p-8 shadow-sm rounded-l-lg'>
              ...
              {/* Column 2: DEPARTMENT VICTORY TARGETS - BLUE/TEAL Theme */}
              <div className='flex-1 flex flex-col items-center justify-center text-center bg-gradient-to-br from-blue-50 to-cyan-50 border-l-2 border-l-stone-200 border-t-4 border-b-4 border-blue-400 border-r-2 border-r-stone-200 p-7 overflow-y-auto shadow-xs'>
