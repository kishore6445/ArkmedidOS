      ...
      <Card className='shadow-sm'>
        ...
        <div className='relative overflow-hidden'>
          ...
          <div className='relative grid grid-cols-3 gap-4'>
            ...
            <div className='absolute top-1/2 -translate-y-1/2 pointer-events-none z-20' style={{ left: 'calc(66.67% - 8px)' }}>
              <ArrowRight className='h-5 w-5' style={{ color: status?.color || '#10b981', opacity: 0.6 }} />
            </div>
            ...
            <div className={cn(
              ...
              <div className='space-y-3'>
                ...
                <div className='py-3'>
                  ...
                  <div className='text-lg font-bold text-stone-400 mt-1'>/100</div>
                </div>
            ...
            <div className='p-6 min-h-[280px] flex flex-col justify-center bg-white rounded-lg border border-stone-200'>
              <div className='space-y-3'>
                ...
                {/* Display top victory target */}
                {victoryTargets.length > 0 && (() => {
                  const vt = victoryTargets[0]
                  const quarters = (vt as any).quarters || []
                  const quarterIndex = ['Q1', 'Q2', 'Q3', 'Q4'].indexOf(selectedQuarter)
