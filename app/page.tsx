    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-6">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-600 text-lg font-semibold text-amber-400">
            ✦
          </div>
          <div>
            <p className="text-xs uppercase tracking-[0.2em] text-blue-600 font-semibold">ArkMedis</p>
      ...
      <main>
        ...
        <section className="mx-auto grid w-full max-w-6xl gap-12 px-6 pb-16 pt-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-600 bg-blue-600 px-4 py-2 text-xs uppercase tracking-[0.2em] text-amber-400 font-semibold">
            ...
            <p className="text-lg text-slate-700">
              ArkMedis is built on a simple belief: <span className="text-blue-600 font-semibold">when people contribute honestly to a shared mission, the company should grow them in return.</span> Mission 50 is our shared goal. Execution is our system. Growth is your reward.
            </p>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <Link
                href="/signup"
                className="rounded-full border border-blue-600 px-6 py-3 text-sm font-semibold text-blue-600 transition hover:bg-blue-50"
              >
                Learn more
              </Link>
            </div>
          ...
          <div className="rounded-3xl border border-blue-600 bg-blue-600 p-8 shadow-lg">
            <div className="space-y-6">
              <div className="rounded-2xl border border-amber-400 bg-white p-5">
                <p className="text-xs uppercase tracking-[0.2em] text-blue-600 font-semibold">Mission 50</p>
                <h2 className="mt-3 text-2xl font-semibold text-slate-900">Three brands, one mission</h2>
              ...
              <div className="grid gap-3">
                {[
                  ...
                  <div
                    key={item.brand}
                    className="rounded-2xl border-2 border-amber-400 bg-white p-4 hover:shadow-md transition"
                  >
                    <p className="text-sm font-semibold text-blue-600">{item.brand}</p>
                    <p className="text-xs text-amber-500 font-bold mt-1">{item.target}</p>
                    <p className="text-xs text-slate-700 mt-2">{item.detail}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="mx-auto w-full max-w-6xl px-6 pb-20">
          <div className="grid gap-6 rounded-3xl border-2 border-blue-600 bg-white p-8 lg:grid-cols-3">
            {[
              {
              ...
              <div key={item.title} className="space-y-3 rounded-lg border-2 border-amber-400 bg-blue-600 p-6 hover:shadow-lg transition">
        ...
        <section className="mx-auto w-full max-w-6xl px-6 pb-20">
          <div className="space-y-12">
            <div className="space-y-4 text-center">
              <h2 className="text-3xl font-semibold text-slate-900">The Principles We Build On</h2>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              {[
                ...
                <div key={item.heading} className="rounded-2xl border-2 border-blue-600 bg-blue-50 p-8 hover:shadow-lg transition">
                  <h3 className="text-xl font-semibold text-blue-600 mb-3">{item.heading}</h3>
        ...
        {/* CTA Section */}
        <section className="mx-auto w-full max-w-6xl px-6 pb-20">
          <div className="rounded-3xl border-2 border-blue-600 bg-blue-600 p-12 text-center shadow-lg">
            ...
            <Link
              href="/signin"
              className="inline-flex rounded-full bg-amber-400 px-8 py-3 text-base font-semibold text-blue-600 transition hover:bg-amber-300"
            >
              Sign in to your account
            </Link>
          </div>
      ...
      <footer className="border-t border-blue-600">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-start justify-between gap-4 px-6 py-8 text-sm text-slate-700 sm:flex-row sm:items-center">
          ...
          <div className="flex items-center gap-4">
            <Link href="/signin" className="hover:text-blue-600 transition font-semibold">
              Sign in
            </Link>
            <Link href="/signup" className="hover:text-blue-600 transition font-semibold">
              Join us
            </Link>
          </div>
        </div>
